...
export const BOSS_STYLES = [
  { name: 'Rupture Core',        shape: 'hex',     colors: ['#3a0800', '#ff4400', '#ff9966'], glow: '#ff7744', lootMul: 1.0 },
  { name: 'Vortex Brute',        shape: 'oct',     colors: ['#0b1630', '#00b7ff', '#8ce6ff'], glow: '#5ad7ff', lootMul: 1.2 },
  { name: 'Crucible Sentinel',   shape: 'cross',   colors: ['#261100', '#ffaa00', '#ffe08a'], glow: '#ffcc55', lootMul: 1.4 },
  { name: 'Nova Warden',         shape: 'diamond', colors: ['#180824', '#b13cff', '#f3b6ff'], glow: '#d97bff', lootMul: 1.6 },
  { name: 'Apex Harbinger',      shape: 'star',    colors: ['#09120c', '#00ff99', '#99ffdd'], glow: '#4effc1', lootMul: 1.8 },
  { name: 'Void Fracture',       shape: 'hex',     colors: ['#0a0014', '#ff00ff', '#ff99ff'], glow: '#ff55ff', lootMul: 2.0 },
  { name: 'Crimson Annihilator', shape: 'oct',     colors: ['#1a0000', '#ff0022', '#ff8899'], glow: '#ff2244', lootMul: 2.2 },
  { name: 'Stellar Colossus',    shape: 'star',    colors: ['#000818', '#44aaff', '#aaddff'], glow: '#66ccff', lootMul: 2.5 },
  { name: 'Abyssal Dread',       shape: 'diamond', colors: ['#060606', '#aaaaaa', '#eeeeee'], glow: '#cccccc', lootMul: 2.8 },
  { name: 'Omega Breach',        shape: 'cross',   colors: ['#0f0000', '#ff6600', '#ffcc99'], glow: '#ff8833', lootMul: 3.2 },
];
...
export function drawBoss(e) {
  ...
  ctx.rotate(e.rot * 3);
  ctx.rotate(-e.rot); // now back to un-rotated

  // Phase 2 pulsing glow ring
  if (e.bossPhase === 2) {
    ctx.beginPath();
